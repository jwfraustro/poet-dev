...
static char mandeltr_module_doc[]="\
This is a test, I wonder were this will show up.\
";

static struct PyModuleDef mandeltr_module=
{
    PyModuleDef_HEAD_INIT,
    "mandeltr",             // name of module 
    mandeltr_module_doc, // module documentation, may be NULL 
    -1,                     // size of per-interpreter state of the module, or -1 if the module keeps state in global variables. 
    mandeltr_methods
};

PyMODINIT_FUNC PyInit_mandeltr(void)
{
  import_array();
  return PyModule_Create(&mandeltr_module);
}
