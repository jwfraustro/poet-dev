...
def secondary_eclipse(params, b=(0, 0), i=(np.pi/2, 0)):
        ...
        print ("Ingress/Egress: ", limbtime(b, d_observed, r_star, r_planet)[0],
               "+/-",limbtime(b, d_observed, r_star, r_planet,
                              sigma_rs=sigma_rs, sigma_rp=sigma_rp,
                              sigma_b=sigma_b, sigma_d=sigma_d)[1], "minutes")
