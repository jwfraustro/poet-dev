...
def suntimecorr(ra, dec, obst,  coordtable, verbose=False):
  ...
  # This will cause a ValueError on extrapolation
  obsx[ti] = splinterp(obstime[ti], time, x, ext=2)
  obsy[ti] = splinterp(obstime[ti], time, y, ext=2)
  obsz[ti] = splinterp(obstime[ti], time, z, ext=2)
