...
def splinterp(x2, x, y, ext=0):
  ...
  ext: integer
       An integer that determines behavior when x2 is not within
       the bounds of x. Options are:
         0: extrapolate (default)
         1: return 0
